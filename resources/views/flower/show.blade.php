...
<div class="container-fluid py-5">
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner border">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="{{asset('img/'.$flower->image) }}" alt="Image">
                    </div>
        ...
        <div class="col-lg-7 pb-5">
            <h3 class="font-weight-semi-bold">{{$flower->name}}</h3>
            ...
            <h3 class="font-weight-semi-bold mb-4">Rp{{number_format($flower->price, 0, ',', '.')}}</h3>
            <p class="mb-4">{{$flower->description}}</p>
            {{-- <div class="d-flex mb-3">
